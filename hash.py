...
def file_type_hashes(files):
    ...
    for file in files:
        ...
        if os.path.isfile(file):
            ...
            print("---------------------------------------------------------------------------")
            print("Filename:\t", file)
            print("Filetype:\t", magic.from_file(file))
            print("Md5:\t\t", md5Hash.hash_file(file))
            print("Sha1:\t\t", sha1Hash.hash_file(file))
            print("Sha256:\t\t", sha256Hash.hash_file(file))
            print("Sha512:\t\t", sha512Hash.hash_file(file))
            print("Crc32:\t\t", crcHash.hash_file(file))
            print("Adler32:\t", adler32Hash.hash_file(file))
            print("---------------------------------------------------------------------------")
